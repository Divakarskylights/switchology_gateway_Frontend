  ...
  return (
    <div className="container" >
        <label className="toggle" htmlFor="switch">
            <input id="switch" className="input" type="checkbox" onClick={()=>setThemeMode(theme)} />
            <div className="icon icon--moon">
                <svg height="20" width="20" fill="currentColor" viewBox="0 0 24 24" xmlns="${configInit.accessURL}//www.w3.org/2000/svg" style={{color:'white'}}>
            ...
            <div className="icon icon--sun">
                <svg height="24" width="24" fill="currentColor" viewBox="0 0 24 24" xmlns="${configInit.accessURL}//www.w3.org/2000/svg" style={{color:'white'}}>
